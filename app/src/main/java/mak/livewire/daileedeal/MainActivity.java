...
public class MainActivity extends ActionBarActivity implements CustomSwipeRefreshLayout.CanChildScrollUpCallback {
...
//refresh
    ...
    public void onBackPressed() {
        ...
        if (mWebView.canGoBack()&&(historyUrl.compareToIgnoreCase("file:///android_asset/splash.html")!=0)) {
            mWebView.goBack();
        ...
        } else {
            {
                ...
                Snackbar.make((FrameLayout)findViewById(R.id.layout), "Please click BACK again to exit", Snackbar.LENGTH_SHORT).show();
